...
output_dir = "D:/ENT_DISEASE_DETECTION/xg_boost"
...
xgb_model = joblib.load("D:/ENT_DISEASE_DETECTION/ent_disease_xgb_model.pkl")
scaler = joblib.load("D:/ENT_DISEASE_DETECTION/xgb_scaler.pkl")
...
y_pred_probs = xgb_model.predict_proba(test_features)  # Get probabilities for ROC curve
...
conf_matrix_path = os.path.join(output_dir, "xgb_confusion_matrix.jpg")
...
performance_heatmap_path = os.path.join(output_dir, "xgb_performance_heatmap.jpg")
...
plt.xticks(rotation=0, ha="center")  
plt.yticks(rotation=0, va="center")  
plt.title("Correlation Heatmap of Predicted Scores (XGBoost Model)")

# ✅ Save Correlation Heatmap
correlation_heatmap_path = os.path.join(output_dir, "xgb_correlation_heatmap.jpg")
...
class_dist_path = os.path.join(output_dir, "xgb_class_distribution.jpg")
...
# ✅ Save ROC Curve Plot
roc_curve_path = os.path.join(output_dir, "xgb_roc_curve.jpg")
